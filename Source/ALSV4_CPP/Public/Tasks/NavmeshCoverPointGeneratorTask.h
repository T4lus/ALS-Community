 ...
 */
class ALSV4_CPP_API FNavmeshCoverPointGeneratorTask : public FNonAbandonableTask
{
...
public:
	FNavmeshCoverPointGeneratorTask(float _CoverPointMinDistance, float _SmallestAgentHeight, float _CoverPointGroundOffset, FBox _MapBounds, int32 _NavmeshTileIndex, UWorld* _World);
};
