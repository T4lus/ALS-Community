...
TCoverOctree::TCoverOctree() : TOctree2<FCoverPointOctreeElement, FCoverPointOctreeSemantics>()
{
}

TCoverOctree::TCoverOctree(const FVector& Origin, float Radius) : TOctree2<FCoverPointOctreeElement, FCoverPointOctreeSemantics>(Origin, Radius)
{
}
