...
FNavmeshCoverPointGeneratorTask::FNavmeshCoverPointGeneratorTask(float _CoverPointMinDistance, float _SmallestAgentHeight, float _CoverPointGroundOffset, FBox _MapBounds, int32 _NavmeshTileIndex, UWorld* _World)
	: CoverPointMinDistance(_CoverPointMinDistance), SmallestAgentHeight(_SmallestAgentHeight), CoverPointGroundOffset(_CoverPointGroundOffset), NavMeshMaxZDistanceFromGround(_CoverPointGroundOffset * 3.0f), MapBounds(_MapBounds), NavmeshTileIndex(_NavmeshTileIndex), World(_World)
{
}
